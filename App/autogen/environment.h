...
Q_IMPORT_QML_PLUGIN(ForksupProjectContentPlugin)
Q_IMPORT_QML_PLUGIN(ForksupProjectPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/ForksupProjectContent/App.qml";
